...
public class MainActivity extends AppCompatActivity
    ...
    private static final String BUNDLE_EXTRA_KEY = "weather";
    ...
    private void loadWeatherData() {
        ...
        bundle.putString(BUNDLE_EXTRA_KEY, location);

        LoaderManager loaderManager = getSupportLoaderManager();
        Loader<String> weatherLoader = loaderManager.getLoader(LOADER_ID);
    ...
    public Loader<String[]> onCreateLoader(int i, final Bundle bundle) {
        ...
        return new AsyncTaskLoader<String[]>(this) {
            ...
            String[] mWeatherReport;

            @Override
            protected void onStartLoading() {

                if (mWeatherReport != null){
                    deliverResult(mWeatherReport);
                }else{
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            Log.d(MainActivity.class.getSimpleName(), "REFRESHED clicked!!!");
