...
public class MainActivity extends AppCompatActivity implements
    ...
    private static boolean isPreferenceUpdated = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* Register to OnChangePreferenceListener to MainActivity.this
         */
...
//        String addressString = "1600 Ampitheatre Parkway, CA";
    ...
    /**
     * At the start, onStart, if the preference flag is set to true (preference has changed), reload the data
     * using initLoader
     * @return void set isPreferenceUpdated to false to be reused
     */
    @Override
    protected void onStart() {
        super.onStart();
        if (MainActivity.isPreferenceUpdated == true){
            invalidateData();
            getSupportLoaderManager().restartLoader(FORECAST_LOADER_ID, null, this);
//            getSupportLoaderManager().initLoader(FORECAST_LOADER_ID, null, MainActivity.this);
//            MainActivity.isPreferenceUpdated = false;
        }
     ...
     * @return void destry the onchangedPreferenceListener
     */
    @Override
    ...
    /**
     * Called whenever Preference changes
     * @return void set the boolean flag isPreferenceUpdated to true
     */
    @Override
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String s) {
        MainActivity.isPreferenceUpdated = true;
    }
}