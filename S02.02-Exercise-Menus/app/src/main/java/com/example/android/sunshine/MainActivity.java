...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPLETE (5) Override onCreateOptionsMenu to inflate the menu for this Activity4
    ...
    // COMPLETE Override onOptionsItemSelected to handle clicks on the refresh button
    @Override
